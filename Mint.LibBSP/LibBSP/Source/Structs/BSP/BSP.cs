...
namespace LibBSP {
	...
	public class BSP : Dictionary<int, LumpInfo> {
		...
		/// <summary>
		/// A <see cref="Node"/> of <see cref="Node"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="LibBSP.TextureInfo"/> of <see cref="LibBSP.TextureInfo"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Face"/> of <see cref="Face"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Leaf"/> of <see cref="Leaf"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Edge"/> of <see cref="Edge"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Model"/> of <see cref="Model"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="BrushSide"/> of <see cref="BrushSide"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Face"/> of <see cref="Face"/> objects in the BSP file representing the Original Faces, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="LibBSP.TextureData"/> of <see cref="LibBSP.TextureData"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Displacement"/> of <see cref="Displacement"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// The <see cref="DisplacementVertex"/> object in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Cubemap"/> of <see cref="Cubemap"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="StaticModel"/> of <see cref="StaticModel"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="LODTerrain"/> of <see cref="LODTerrain"/> objects in the BSP file, if available.
		/// </summary>
		...
		/// <summary>
		/// A <see cref="Patch"/> of <see cref="Patch"/> objects in the BSP file, if available.
		/// </summary>
